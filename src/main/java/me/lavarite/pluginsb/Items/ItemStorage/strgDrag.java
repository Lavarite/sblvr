...
public class strgDrag {
    ...
    private static void DC() {
        ...
        metaDC.addItemFlags(ItemFlag.HIDE_ATTRIBUTES);
        metaDC.addItemFlags(ItemFlag.HIDE_UNBREAKABLE);
    ...
    private static void GF() {
        ...
        metaGF.addItemFlags(ItemFlag.HIDE_ATTRIBUTES);
        metaGF.addItemFlags(ItemFlag.HIDE_UNBREAKABLE);
    ...
    private static void SF() {
        ...
        metaSF.addItemFlags(ItemFlag.HIDE_ATTRIBUTES);
        metaSF.addItemFlags(ItemFlag.HIDE_UNBREAKABLE);
    ...
    private static void NF() {
        ...
        metaNF.addItemFlags(ItemFlag.HIDE_ATTRIBUTES);
        metaNF.addItemFlags(ItemFlag.HIDE_UNBREAKABLE);
    ...
    private static void LF() {
        ...
        metaLF.addItemFlags(ItemFlag.HIDE_ATTRIBUTES);
        metaLF.addItemFlags(ItemFlag.HIDE_UNBREAKABLE);
